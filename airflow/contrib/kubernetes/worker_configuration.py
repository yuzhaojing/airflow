...
class WorkerConfiguration(LoggingMixin):
    ...
    def init_volumes_and_mounts(self):
        ...
        volumes = {
            ...
            self.prop_volume_name: _construct_volume(
                self.prop_volume_name,
                self.kube_config.prop_volume_claim,
                self.kube_config.prop_volume_host
            )
        }
        ...
        volume_mounts = {
            ...
            self.prop_volume_name: {
                'name': self.prop_volume_name,
                'mountPath': self.worker_airflow_prop,
            }
        }
        ...
        if self.kube_config.prop_volume_subpath:
            volume_mounts[self.prop_volume_name]['subPath'] = self.kube_config.prop_volume_subpath
        ...
        if not self.kube_config.prop_volume_host and not self.kube_config.prop_volume_claim:
            del volumes[self.prop_volume_name]
            del volume_mounts[self.prop_volume_name]
